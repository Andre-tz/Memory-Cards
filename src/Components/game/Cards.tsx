...
const Cards = ( { name } : CardsProps )=>{
    ...
    return(
        <div className="perspective-[1000px]">
            <div className="w-[100px] h-[150px] rounded-[20px] border relative flex justify-center items-center transition  hover:rotate-y-180 duration-500 preserve-3d">
                ...
                <div className={ `${ cardsStyles } absolute top-0 left-0 rotate-y-180 flex justify-center items-center`}>
                    <img className={ `${ imgStyles} object-contain` } src={ `./src/images/${ name }.webp`} alt={ `foto de ${name }` }/>
                </div>
            </div>
        </div>
    )
